...
HRESULT CombatSkill::init()
{
	Skill::init();

	_img.skillIcon = IMAGEMANAGER->findImage("전투스킬아이콘");
	_img.skillFrame = IMAGEMANAGER->findImage("전투스킬프레임");
...
void CombatSkill::release()
{

}

void CombatSkill::update()
{
	for (int i = 0; i < 40; i++)
	{
