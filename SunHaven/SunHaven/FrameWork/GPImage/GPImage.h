...
public:
	HRESULT init(char* fileName, int destX, int destY, int maxFrameX, int maxFrameY, bool isTrans, COLORREF color = RGB(0, 0, 0), Gdiplus::RotateFlipType rotateFlipType = Gdiplus::RotateNoneFlipNone);
	void release(void);
